...
async function run() {
  try {
    ...
    const inboundRes = await axios.post('https://tekke53-rpms.hf.space/api/warehouse/inbound', {
      weight: 250,
      grade: 'A',
      notes: 'Testing HF DB',
    ...
    const approveRes = await axios.put(`https://tekke53-rpms.hf.space/api/warehouse/inbound/${id}/approve`, {
